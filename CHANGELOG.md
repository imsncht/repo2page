...
### Fixed
- **HTML Formatter:** Resolved a visibility issue where the directory tree was invisible due to CSS color conflicts. Added robust styling with higher specificity and high-contrast colors.
